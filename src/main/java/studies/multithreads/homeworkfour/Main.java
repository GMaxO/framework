package studies.multithreads.homeworkfour;
...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread a = new Thread(() -> {
            ...
            System.out.println("Максимальное количество " + letter + " = " + maxA + " букв");
        });
        a.start();
        ...
        Thread b = new Thread(() -> {
            ...
            System.out.println("Максимальное количество " + letter + " = " + maxB + " букв");
        });
        b.start();
        ...
        Thread c = new Thread(() -> {
            ...
            System.out.println("Максимальное количество " + letter + " = " + maxC + " букв");
        });
        c.start();
